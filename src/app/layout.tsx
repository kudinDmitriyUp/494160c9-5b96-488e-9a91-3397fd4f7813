...
export const metadata: Metadata = {
  title: "StaffToday.AI - AI Recruitment Agency for Construction",
  description: "The only 360 AI recruitment agency specializing in Australian construction. Save 75% time, reduce costs 60%, achieve 95% candidate matching accuracy.",
  keywords: "AI recruitment, construction hiring, Australian construction jobs, AI-powered recruitment, construction talent acquisition",
  metadataBase: new URL("https://stafftoday.ai"),
  alternates: {
    canonical: "https://stafftoday.ai"
  },
  openGraph: {
    title: "StaffToday.AI - AI Recruitment Agency for Construction",
    description: "Transform construction hiring with AI. Save 75% time, reduce costs 60%, achieve 95% candidate matching accuracy.",
    url: "https://stafftoday.ai",
    siteName: "StaffToday.AI",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763456502865-of2iuym5.jpg",
        alt: "StaffToday.AI AI recruitment platform"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "StaffToday.AI - AI Recruitment Agency for Construction",
    description: "Transform construction hiring with AI. Save 75% time, reduce costs 60%, achieve 95% candidate matching accuracy.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763456502865-of2iuym5.jpg"]
  },
  robots: {
    index: true,
    follow: true
